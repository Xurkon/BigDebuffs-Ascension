			...
			unitFrames = {
				...
				args = {
					...
					raid = {
						type = "group",
						disabled = function(info) return not self.db.profile[info[1]].enabled or (info[3] and not self.db.profile.unitFrames[info[2]].enabled) end,
						get = function(info) local name = info[#info] return self.db.profile.unitFrames.raid[name] end,
						set = function(info, value) local name = info[#info] self.db.profile.unitFrames.raid[name] = value self:Refresh() self:Refresh() end,
						args = {
							enabled = {
								type = "toggle",
								disabled = function(info) return not self.db.profile[info[1]].enabled end,
							...
							offsetX = {
								...
								disabled = function(info) local name = info[2] return not self.db.profile.unitFrames[name].enabled end,
								name = "Offset X",
								desc = "Adjust the horizontal position of the BigDebuffs icon (negative = left, positive = right)",
								min = -100,
								max = 100,
								step = 1,
								order = 4.1,
							...
							offsetY = {
								...
								disabled = function(info) local name = info[2] return not self.db.profile.unitFrames[name].enabled end,
								name = "Offset Y",
								desc = "Adjust the vertical position of the BigDebuffs icon (negative = down, positive = up)",
								min = -100,
								max = 100,
								step = 1,
								order = 4.2,
							...
							spells = {
								...
								args = {
									...
									snare = {
										...
										width = "normal",
										name = L["snare"],
										desc = L["Show Snare on the unit frames"],
										order = 10,
									},
								},
							},
						...
						name = "Raid Frames",
						desc = "Enable BigDebuffs on raid frames (requires LibGetFrame)",
						order = 9,
					},
					nameplate = {
						type = "group",
						disabled = function(info) return not self.db.profile[info[1]].enabled or (info[3] and not self.db.profile.unitFrames[info[2]].enabled) end,
						get = function(info) local name = info[#info] return self.db.profile.unitFrames.nameplate[name] end,
						set = function(info, value) local name = info[#info] self.db.profile.unitFrames.nameplate[name] = value self:Refresh() self:Refresh() end,
						args = {
							enabled = {
								type = "toggle",
								disabled = function(info) return not self.db.profile[info[1]].enabled end,
							...
							spells = {
								...
								args = {
									...
									silence = {
										...
										width = "normal",
										name = L["silence"],
										desc = L["Show Silence on nameplates"],
										order = 3,
									},
									interrupts = {
										type = "toggle",
									...
									disarm = {
										...
										width = "normal",
										name = L["disarm"],
										desc = L["Show Disarm on nameplates"],
										order = 6,
									},
									buffs_defensive = {
										type = "toggle",
									...
									snare = {
										...
										width = "normal",
										name = L["snare"],
										desc = L["Show Snare on nameplates"],
										order = 10,
									},
								},
							},
						...
						name = "Nameplates",
						desc = "Enable BigDebuffs on nameplates (requires C_NamePlate API)",
						order = 10,
					},
				},
			},
